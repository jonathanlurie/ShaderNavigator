...
d;this._resolutionLevel=a;this._sizeWC=c;this._threeJsTexture=null;this._triedToLoad=this._textureLoadingError=this._isBuilt=!1;this._textureLoader=this._onTextureLoadErrorCallback=this._onTextureLoadedCallback=null;"precomputed_octree_tiles"==e&&(this._textureLoader=new C(this))};t.prototype.getVoxelPerSide=function(){return this._voxelPerSide};t.prototype.getIndex3D=function(){return this._index3D.slice()};t.prototype.getWorkingDir=function(){return this._workingDir};t.prototype.getResolutionLevel=
...
0<b&&b<this._boundingBox[1]&&0<c&&c<this._boundingBox[2]};p.prototype.onConfigError=function(a){this._onConfigErrorCallback=a};p.prototype.getLevelInfo=function(a,b){if(0<=a&&a<this._levelsInfo.length&&b in this._levelsInfo[a])return this._levelsInfo[a][b]};var z=function(a){this._sphere=new THREE.Object3D;this._initRadius=a;var b=new THREE.CircleGeometry(a,64),c=new THREE.CircleGeometry(a,64),d=new THREE.CircleGeometry(a,64),k=new THREE.LineBasicMaterial({color:16724787,linewidth:1.5}),e=new THREE.LineBasicMaterial({color:60238,
...
n.prototype.getSurfaceProperties=function(){return this._shapeData.surfaceProperties};var B=function(a,b){this._container=b;this._meshes={};this._collectionBox=this._configFileDir=null;this._readConfig(a)};B.prototype._readConfig=function(a){var b=this,c=a.url;l.loadTextFile(c,function(a){b._configFileDir=c.substring(0,Math.max(c.lastIndexOf("/"),c.lastIndexOf("\\")))+"/";b._loadConfigDescription(JSON.parse(a))},function(a){console.error("Could not load config file "+c);b._onConfigErrorCallback&&
b._onConfigErrorCallback(c,0)})};B.prototype._loadConfigDescription=function(a){var b=this;a.forEach(function(a){var c=a.url;"near"==a.urlType&&(c=b._configFileDir+c);l.loadTextFile(c,function(c){var d=new n;d.parse(c);c=b._buildMeshFromObjReader(d);c.geometry.computeBoundingBox();c.name=a.id;c.userData.longName=a.name;c.userData.description=a.description;"eulerAngle"in a&&c.rotation.set(a.eulerAngle[0],a.eulerAngle[1],a.eulerAngle[2]);"scale"in a&&c.scale.set(a.scale[0],a.scale[1],a.scale[2]);"position"in
...
new THREE.BufferAttribute(e,3,!0));b.addAttribute("color",new THREE.BufferAttribute(f,4,!0));b.computeBoundingSphere();a=new THREE.MeshPhongMaterial({specular:16777215,shininess:250,side:THREE.DoubleSide,vertexColors:THREE.VertexColors,transparent:!0,opacity:a.getSurfaceProperties().transparency});return new THREE.Mesh(b,a)};B.prototype._updateCollectionBox=function(a){this._collectionBox?this._collectionBox.union(a.geometry.boundingBox):this._collectionBox=a.geometry.boundingBox.clone()};var w=function(a){this._quadScene=
a;this._resolutionLevel=this._quadScene.getResolutionLevel();this._resolutionLvlRange=[0,6];this._resolutionLvlSliderBuilt=!1;this._resolutionDescription="";this._colormapManager=this._quadScene.getColormapManager();this._colormapManager.onColormapUpdate(this._updateColormapList.bind(this));this._annotationCollection=this._quadScene.getAnnotationCollection();this._mainPanel=QuickSettings.create(5,0,document.title);this._initMainPanel()};w.prototype._initMainPanel=function(){var a=this;this._mainPanel.addBoolean("Compass",
1,function(b){a._quadScene.getOrientationHelper().setVisibility(b)});this._mainPanel.addBoolean("Bounding box",1,function(b){a._quadScene.getBoundingBoxHelper().setVisibility(b)});document.getElementById("Bounding box").parentElement.parentElement.style["margin-top"]="0px";this._mainPanel.addRange("Zoom level",0,6,0,1,function(b){b=Math.floor(b);a._updateResolutionDescription(b,a._quadScene.getLevelManager().getLevelInfo(a._resolutionLevel,"key")+" \u27a4 ")},function(b){b=Math.floor(b);a._resolutionLevel=
b;a._quadScene.setResolutionLevel(b)});this._mainPanel.addText("Resolution","");this._mainPanel.overrideStyle("Resolution","background-color","transparent");document.getElementById("Resolution").readOnly=!0;document.getElementById("Resolution").parentElement.style["margin-top"]="0px";this._mainPanel.addText("Position","",function(){});this._mainPanel.overrideStyle("Position","text-align","center");this._mainPanel.addText("Rotation","",function(){});this._mainPanel.overrideStyle("Rotation","margin-top",
"0px");this._mainPanel.overrideStyle("Rotation","text-align","center");document.getElementById("Rotation").parentElement.style["margin-top"]="0px";this._mainPanel.addButton("Apply",function(){var b=a._mainPanel.getValue("Position").split(",").map(function(a){return parseFloat(a)}),c=a._mainPanel.getValue("Rotation").split(",").map(function(a){return parseFloat(a)});a._quadScene.setMultiplaneRotation(c[0],c[1],c[2]);a._quadScene.setMultiplanePosition(b[0],b[1],b[2])});this._mainPanel.overrideStyle("Apply",
"width","100%");document.getElementById("Apply").parentElement.style["margin-top"]="0px";this._mainPanel.addButton("Reset rotation",function(){a._quadScene.setMultiplaneRotation(0,0,0)});this._mainPanel.overrideStyle("Reset rotation","width","100%");document.getElementById("Reset rotation").parentElement.style["margin-top"]="0px"};w.prototype._toggleOrientationHelper=function(){this._quadScene.getOrientationHelper().toggle()};w.prototype._toggleBoundingBoxHelper=function(){this._quadScene.getBoundingBoxHelper().toggle()};
w.prototype.updateResolutionLevelUI=function(a){this._resolutionLevel=a;this._mainPanel.setValue("Zoom level",a);this._updateResolutionDescription(this._resolutionLevel)};w.prototype.updateMultiplaneUI=function(a){var b=a.position.x.toFixed(4)+" , ",b=b+(a.position.y.toFixed(4)+" , "),b=b+a.position.z.toFixed(4);this._mainPanel.setValue("Position",b);b=a.rotation.x.toFixed(4)+" , ";b+=a.rotation.y.toFixed(4)+" , ";b+=a.rotation.z.toFixed(4);this._mainPanel.setValue("Rotation",b)};w.prototype._updateResolutionDescription=
function(a,b){this._resolutionDescription=(void 0===b?"":b)+this._quadScene.getLevelManager().getLevelInfo(a,"key");this._mainPanel.setValue("Resolution",this._resolutionDescription)};w.prototype._updateColormapList=function(){var a=this;this._mainPanel.addDropDown("Colormap",this._colormapManager.getAvailableColormaps(),function(b){a._colormapManager.useColormap(b.value)})};w.prototype._initAnnotationPanel=function(){var a=this;this._annotationPanel.addFileChooser("Annotation file","Open","",function(b){a._annotationCollection.loadAnnotationFileDialog(b)});
...
function(a){console.log(a)};document.getElementById("newAnnotDelete").onclick=function(a){console.log(a)}};var A=function(a){this._size=null;this._parentElem=a;this._boundingBox3D=null};A.prototype.build=function(a){this._size=a.slice();if(!this._boundingBox3D){this._boundingBox3D=new THREE.Object3D;a=new THREE.MeshBasicMaterial({transparent:!0,opacity:.8,color:16777215,vertexColors:THREE.FaceColors,side:THREE.BackSide});var b=new THREE.BoxGeometry(this._size[0],this._size[1],this._size[2]);b.faces[0].color.setHex(16743034);
...
this._eulerAngle[2]);this._meshMustRebuild=!0;this._buildAnnotationObject3D()};v.prototype.validateAnnotation=function(){this._isValid=!0;this._isValid=this._points.length?!this._points.some(function(a){return 3!=a.length}):!1};v.prototype.addPoint=function(a){if(this._isClosed)console.warn("The annotation is a closed polygon. You must to first remove the last point to open the loop.");else if(3==a.length){this._points.push(a);if(2==this._points.length)this.flushObject3D(),this._buildLinestringAnnotation();
else{var b=this._object3D.children[0];b.geometry.vertices.push(new THREE.Vector3(a[0],a[1],a[2]));b.geometry.computeBoundingSphere();b.geometry.dynamic=!0;b.geometry.verticesNeedUpdate=!0}this.validateAnnotation()}};v.prototype.removeLastPoint=function(){this._isClosed&&(console.warn("The polygon just got open."),this._isClosed=!1);if(this._isValid){this._points.pop();if(0==this._points.length)this.flushObject3D();else if(1==this._points.length)this.flushObject3D(),this._buildPointAnnotation();else{var a=
this._object3D.children[0];a.geometry.vertices.pop();a.geometry.computeBoundingSphere();a.geometry.dynamic=!0;a.geometry.verticesNeedUpdate=!0}this.validateAnnotation()}};v.prototype.getObject3D=function(){return this._object3D};v.prototype._buildPointAnnotation=function(){if(this._isValid){var a=new THREE.BufferGeometry,b=new Float32Array(this._points[0]),c=new THREE.PointsMaterial({size:10,color:new THREE.Color(this._color),sizeAttenuation:!1});a.addAttribute("position",new THREE.BufferAttribute(b,
3));a.computeBoundingSphere();a.dynamic=!0;a.verticesNeedUpdate=!0;a=new THREE.Points(a,c);a.layers.enable(0);a.layers.enable(1);this._object3D.add(a);this._meshMustRebuild=!1}};v.prototype._buildLinestringAnnotation=function(){if(this._isValid){var a=new THREE.Geometry,b=new THREE.LineBasicMaterial({linewidth:1,color:new THREE.Color(this._color)});this._points.forEach(function(b){a.vertices.push(new THREE.Vector3(b[0],b[1],b[2]))});this._isClosed&&2<this._points.length&&a.vertices.push(new THREE.Vector3(this._points[0][0],
this._points[0][1],this._points[0][2]));a.computeLineDistances();b=new THREE.Line(a,b);b.layers.enable(0);b.layers.enable(1);b.geometry.dynamic=!0;b.geometry.verticesNeedUpdate=!0;this._object3D.add(b);this._meshMustRebuild=!1}};v.prototype._buildAnnotationObject3D=function(){this._isValid?this._object3D.children.length?console.warn("The object3D/mesh for this annotation is already built. Maybe use a modifying method instead."):1==this._points.length?this._buildPointAnnotation():this._buildLinestringAnnotation():
console.warn("This annotation is not valid. Possible reasons: no points OR points number of dimension is not consistant.")};v.prototype.flushObject3D=function(){this._object3D.children.forEach(function(a){this._object3D.remove(a)})};v.prototype.closeLinestring=function(){this._isClosed?console.warn("The annotation linestring is already closed."):2<this._points.length&&(this._isClosed=!0,this.addPoint(this._points[this._points.length-1]))};v.prototype.updateName=function(a){this._name=a;this._object3D.name=
a};v.prototype.updateDescription=function(a){this._description=a;this._object3D.userData.description=a};v.prototype.updateColor=function(a){this._color=a;"#"!=this._color[0]&&(this._color="#"+this._color);this._object3D.children.length&&this._object3D.children[0].material.color.set(this._color)};var x=function(){this._collection={};this._container3D=new THREE.Object3D;this._container3D.name="annotation collection";this._noNameIncrement=0;this._tempAnnotation=this._onAddingAnnotationCallback=null};
x.prototype.getContainer3D=function(){return this._container3D};x.prototype.addAnnotation=function(a,b,c){c=void 0===c?{}:c;b in this._collection?console.warn(b+" is already in the collection"):(b=b||this._getNewAnnotationName(),this._collection[b]=new v(a,b,c),this._container3D.add(this._collection[b].getObject3D()),this._onAddingAnnotationCallback&&this._onAddingAnnotationCallback(b))};x.prototype._getNewAnnotationName=function(){this._noNameIncrement++;return"annotation_"+this._noNameIncrement+
"_"+(new Date).toISOString()};x.prototype.removeAnnotation=function(a){a in this._collection?(this._container3D.remove(this._collection[a].getObject3D()),delete this._collection[a]):console.warn(a+" annotation is not in the collection. Impossible to remove.")};x.prototype.loadAnnotationFileURL=function(a,b){var c=this;((void 0===b?0:b)?l.loadCompressedTextFile:l.loadTextFile)(a.url,function(a){c._loadAnnotationFileContent(a)},function(b){console.warn("Couldnt load the annotation file: "+a.url)})};
x.prototype.loadAnnotationFileDialog=function(a){var b=this,c=new FileReader;c.onload=function(a){b._loadAnnotationFileContent(a.target.result)};c.readAsText(a)};x.prototype._loadAnnotationFileContent=function(a){var b=this,c="color description isClosed eulerAngle scale position".split(" ");JSON.parse(a).annotations.forEach(function(a){if("points"in a&&0!=a.points.length){var d={},e="name"in a?a.name:null;c.forEach(function(b){b in a&&(d[b]=a[b])});b.addAnnotation(a.points,e,d)}})};x.prototype.onAddingAnnotation=
function(a){this._onAddingAnnotationCallback=a};x.prototype.createTemporaryAnnotation=function(a){this._tempAnnotation?console.warn("A temporaray annotation is already created. Validate it or discard it before creating a new one."):(this._tempAnnotation=new v([[a.x,a.y,a.z]],this._getNewAnnotationName(),{description:"No description yet",isClosed:!1}),this._container3D.add(this._tempAnnotation))};x.prototype.deleteTemporaryAnnotation=function(){this._tempAnnotation?(this._container3D.remove(this._tempAnnotation),
this._tempAnnotation=null):console.warn("No temporary annotation to delete.")};x.prototype.getTemporaryAnnotation=function(){return this._tempAnnotation};g=function(a,b){b=void 0===b?0:b;window.addEventListener("resize",this._updateSize.bind(this),!1);this._ready=!1;this._counterRefresh=0;this._resolutionLevel=b;this._quadViews=[];this._onConfigFileErrorCallback=this._onReadyCallback=this._onChangeCallback=this._orientationHelper=this._planeManager=this._quadViewInteraction=null;this._colormapManager=
new y;this._domContainer=document.getElementById(a);this._scene=new THREE.Scene;this._boundingBoxHelper=new A(this._scene);this._scene.add(new THREE.AmbientLight(4473924));b=new THREE.DirectionalLight(16777215,.75);b.position.set(200,200,200);b.layers.enable(0);b.layers.enable(1);this._scene.add(b);this._adjustedContainer=new THREE.Object3D;this._annotationCollection=new x;this._meshContainer=new THREE.Object3D;this._adjustedContainer.add(this._meshContainer);this._adjustedContainer.add(this._annotationCollection.getContainer3D());
this._scene.add(this._adjustedContainer);this._renderer=new THREE.WebGLRenderer({antialias:!0});this._renderer.setPixelRatio(window.devicePixelRatio);this._renderer.setSize(window.innerWidth,window.innerHeight);this._domContainer.appendChild(this._renderer.domElement);this._cameraDistance=50;this._scene.fog=new THREE.Fog(15658734,this._cameraDistance,2*this._cameraDistance);this._renderer.setClearColor(this._scene.fog.color);this._windowSize={width:0,height:0};this._stats=this._meshCollection=null;
this._initPlaneManager();this._initViews(a);this._levelManager=new p;this._guiController=new w(this);this._animate()};g.prototype._initViews=function(a){var b=this,c=new f(this._scene,this._renderer,this._cameraDistance);c.initTopLeft();c.initOrthoCamera();c.useRelativeCoordinatesOf(this._planeManager.getMultiplaneContainer());c.enableLayer(0);var d=new f(this._scene,this._renderer,this._cameraDistance);d.initTopRight();d.initOrthoCamera();d.useRelativeCoordinatesOf(this._planeManager.getMultiplaneContainer());
...
new r(this._quadViews,a);this._quadViewInteraction.setMultiplaneContainer(this._planeManager.getMultiplaneContainer());this._quadViewInteraction.onClickPlane("perspective",function(a){b.setMultiplanePosition(a.x,a.y,a.z)})};g.prototype.getLevelManager=function(){return this._levelManager};g.prototype.setMultiplanePosition=function(a,b,c){this._planeManager.setMultiplanePosition(a,b,c);this._guiController.updateMultiplaneUI(this.getMultiplaneContainerInfo())};g.prototype.setMultiplaneRotation=function(a,
b,c){this._planeManager.setMultiplaneRotation(a,b,c);this._guiController.updateMultiplaneUI(this.getMultiplaneContainerInfo())};g.prototype._initPlaneManager=function(){var a=this;this._planeManager=new h(this._colormapManager,this._scene);this._planeManager.enableLayerHiRez(0);this._planeManager.disableLayerHiRez(1);this._planeManager.enableLayerLoRez(1);this._planeManager.disableLayerLoRez(0);this._planeManager.onMultiplaneMove(function(b){a._updatePerspectiveCameraLookAt(b);a._syncOrientationHelperPosition(b)})};
g.prototype.initStat=function(){this._stats=new Stats;this._domContainer.appendChild(this._stats.dom);this._stats.dom.style.right="0";this._stats.dom.style.left="initial";this._stats.dom.style.top="0";this._stats.dom.style.position="absolute"};g.prototype._updateSize=function(){if(this._windowSize.width!=window.innerWidth||this._windowSize.height!=window.innerHeight)this._windowSize.width=window.innerWidth,this._windowSize.height=window.innerHeight,this._quadViewInteraction.updateWindowSize(this._windowSize.width,
this._windowSize.height),this._renderer.setSize(this._windowSize.width,this._windowSize.height)};g.prototype.getResolutionLevel=function(){return this._resolutionLevel};g.prototype.getColormapManager=function(){return this._colormapManager};g.prototype._animate=function(){this._render();this._stats&&this._stats.update();requestAnimationFrame(this._animate.bind(this));this._quadViews[3].updateControl()};g.prototype._render=function(){this._ready&&(0==this._counterRefresh%30&&this._updateAllPlanesShaderUniforms(),
this._counterRefresh++);this._quadViews.forEach(function(a){a.renderView()})};g.prototype.getOrientationHelper=function(){return this._orientationHelper};g.prototype.getBoundingBoxHelper=function(){return this._boundingBoxHelper};g.prototype.loadData=function(a){"precomputed_octree_tiles"==a.datatype?this._initLevelManager(a):"mesh_collection"==a.datatype?this._initMeshCollection(a):"colormap_collection"==a.datatype?this._colormapManager.loadCollection(a):"annotation_collection"==a.datatype?this._annotationCollection.loadAnnotationFileURL(a):
...
this._planeManager.updateScaleFromRezLvl(this._resolutionLevel);this._syncOrientationHelperScale();var b=4*this._orientationHelper.getRadius();this._scene.fog.far=this._cameraDistance+b;this._updateOthoCamFrustrum();this._guiController.updateResolutionLevelUI(a);this._onUpdateViewCallback&&this._onUpdateViewCallback(this.getMultiplaneContainerInfo())};g.prototype._updateAllPlanesShaderUniforms=function(){this._planeManager.updateUniforms()};g.prototype._updatePerspectiveCameraLookAt=function(a){this._quadViews[3].updateLookAt(a)};
...
d);break;case 2:a._planeManager.translateMultiplaneZ(b.x/d,-b.y/d)}});this._quadViewInteraction.onGrabViewRotate(function(b,c,d){switch(d){case 0:a._planeManager.rotateMultiplaneX(b*c);break;case 1:a._planeManager.rotateMultiplaneY(b*c*-1);break;case 2:a._planeManager.rotateMultiplaneZ(b*c)}});this._quadViewInteraction.onGrabViewTransverseRotate(function(b,c){var d=a._resolutionLevel/2;switch(c){case 0:a._planeManager.rotateMultiplaneZ(b.x/d);a._planeManager.rotateMultiplaneY(-b.y/d);break;case 1:a._planeManager.rotateMultiplaneX(-b.y/
d);a._planeManager.rotateMultiplaneZ(b.x/d);break;case 2:a._planeManager.rotateMultiplaneX(-b.y/d),a._planeManager.rotateMultiplaneY(b.x/d)}});this._quadViewInteraction.onArrowDown(function(b){var c=a._levelManager.getBoundingBox()[0]/a._levelManager.getLevelInfo(a._resolutionLevel,"size")[0];switch(b){case 0:a._planeManager.translateMultiplaneY(-c,0);break;case 1:a._planeManager.translateMultiplaneX(-c,0);break;case 2:a._planeManager.translateMultiplaneY(0,-c)}});this._quadViewInteraction.onArrowUp(function(b){var c=
a._levelManager.getBoundingBox()[0]/a._levelManager.getLevelInfo(a._resolutionLevel,"size")[0];switch(b){case 0:a._planeManager.translateMultiplaneY(c,0);break;case 1:a._planeManager.translateMultiplaneX(c,0);break;case 2:a._planeManager.translateMultiplaneY(0,c)}});this._quadViewInteraction.onDonePlaying(function(){a._guiController.updateMultiplaneUI(a.getMultiplaneContainerInfo());a._onUpdateViewCallback&&a._onUpdateViewCallback(a.getMultiplaneContainerInfo())})};g.prototype.getMultiplaneContainerInfo=
function(){var a=this._planeManager.getMultiplanePosition(),b=this._planeManager.getMultiplaneRotation();return{resolutionLvl:this._resolutionLevel,position:{x:a.x,y:a.y,z:a.z},rotation:{x:b.x,y:b.y,z:b.z}}};g.prototype.onUpdateView=function(a){this._onUpdateViewCallback=a};g.prototype.onConfigFileError=function(a){this._onConfigFileErrorCallback=a};g.prototype.getAnnotationCollection=function(){return this._annotationCollection};e.HashIO=m;e.QuadScene=g;Object.defineProperty(e,"__esModule",{value:!0})});
