...
a);c&&c(status)};d.send(null)}else c("Pako lib is not available, please include it to your project.")};m.isPakoAvailable=function(){var a=!0;try{pako}catch(b){console.warn(b),a=!1}return a};var g=function(a){this._textureChunk=a},A=function(a){this._textureChunk=a;return this};$jscomp.inherits(A,g);A.prototype._buildFileName=function(){var a=this._textureChunk.getIndex3D(),b=this._textureChunk.getVoxelPerSide(),c=this._textureChunk.getWorkingDir(),d=this._textureChunk.getResolutionLevel(),k=a[0]*
b,e=a[1]*b,a=a[2]*b;return c+"/"+d+"/"+k+"-"+(k+b)+"/"+e+"-"+(e+b)+"/"+a+"-"+(a+b)};A.prototype.loadTexture=function(){var a=this._buildFileName(),b=this,c=(new THREE.TextureLoader).load(a,function(){c.magFilter=THREE.NearestFilter;c.minFilter=THREE.NearestFilter;b._textureChunk.setTexture(c);b._textureChunk.onTextureSuccessToLoad()},function(){},function(){b._textureChunk.onTextureFailedToLoad()})};var r=function(a,b,c,d,k,e,f){this._chunkID=k;this._matrix3DSize=f;this._voxelPerSide=b;this._workingDir=
d;this._resolutionLevel=a;this._sizeWC=c;this._threeJsTexture=null;this._triedToLoad=this._textureLoadingError=this._isBuilt=!1;this._textureLoader=this._onTextureLoadErrorCallback=this._onTextureLoadedCallback=null;"precomputed_octree_tiles"==e&&(this._textureLoader=new A(this))};r.prototype.getVoxelPerSide=function(){return this._voxelPerSide};r.prototype.getIndex3D=function(){return this._index3D.slice()};r.prototype.getWorkingDir=function(){return this._workingDir};r.prototype.getResolutionLevel=
function(){return this._resolutionLevel};r.prototype.setTexture=function(a){this._threeJsTexture=a};r.prototype.buildFromIndex3D=function(a){this._index3D=a.slice();this._findChunkOrigin();this._triedToLoad||this._textureLoader.loadTexture();this._isBuilt=!0};r.prototype._findChunkOrigin=function(){this._originWC=new THREE.Vector3(this._index3D[0]*this._sizeWC,this._index3D[1]*this._sizeWC,this._index3D[2]*this._sizeWC)};r.prototype.onTextureSuccessToLoad=function(){this._textureLoadingError=!1;this._triedToLoad=
!0;this._onTextureLoadedCallback&&this._onTextureLoadedCallback(this._chunkID)};r.prototype.onTextureFailedToLoad=function(){this._threeJsTexture=null;this._triedToLoad=this._textureLoadingError=!0;this._onTextureLoadErrorCallback&&this._onTextureLoadErrorCallback(this._chunkID)};r.prototype._loadTextureDecode=function(){var a=this,b=new XMLHttpRequest;b.open("GET",this._filepath);b.responseType="arraybuffer";b.onload=function(){var c=new Uint8Array(b.response),d,k;k=new JpegDecoder;k.parse(c);c=
...
b.send()};r.prototype.getChunkTextureData=function(){return{texture:this._threeJsTexture,origin:this._originWC,valid:!this._textureLoadingError}};r.prototype.getTextureFilepath=function(){return this._filepath};r.prototype.loadingError=function(){return this._textureLoadingError};r.prototype.onTextureLoaded=function(a){this._onTextureLoadedCallback=a};r.prototype.onTextureLoadError=function(a){this._onTextureLoadErrorCallback=a};var u=function(a,b,c,d){this._chunks={};this._datatype=d;this._workingDir=
c;this._matrix3DSize=b;this._resolutionLevel=a;this._chunkSizeLvlZero=1;this._voxelPerSide=64;this._sizeChunkWC=this._chunkSizeLvlZero/Math.pow(2,this._resolutionLevel);this._createFakeTexture();this._chunkCounter={toBeLoaded:0,loaded:0,failled:0};this._onChunksLoadedCallback=null};u.prototype._initChunkFromIndex3D=function(a){var b=this,c=this.getKeyFromIndex3D(a);this._chunks[c]=new r(this._resolutionLevel,this._voxelPerSide,this._sizeChunkWC,this._workingDir,c,this._datatype,this._matrix3DSize);
...
this._onChunksLoadedCallback())};u.prototype.onChunkLoaded=function(a){this._onChunksLoadedCallback=a};var t=function(){this._chunkCollections=[];this._workingDir="";this._resolutionLevel=0;this._boundingBox=this.onReadyCallback=null;this._chunkSize=[64,64,64];this._onConfigErrorCallback=null};t.prototype.onReady=function(a){this.onReadyCallback=a};t.prototype.loadConfig=function(a){var b=this,c=a.url;m.loadTextFile(c,function(d){b._workingDir=c.substring(0,Math.max(c.lastIndexOf("/"),c.lastIndexOf("\\")));
b._loadConfigDescription(a.datatype,JSON.parse(d))},function(a){console.error("Could not load config file "+c);b._onConfigErrorCallback&&b._onConfigErrorCallback(c,0)})};t.prototype._loadConfigDescription=function(a,b){var c=this;b=b.scales;0<b.length&&b.sort(function(a,b){return a.resolution[0]>b.resolution[0]?-1:1});this._determineChunkSize(b);this._computeBoundingBox(b);b.forEach(function(b,k){c._addChunkCollectionLevel(k,b.size,a)});if(this.onReadyCallback)this.onReadyCallback()};t.prototype._addChunkCollectionLevel=
function(a,b,c){this._chunkCollections.push(new u(a,[Math.ceil(b[0]/this._chunkSize[0]),Math.ceil(b[1]/this._chunkSize[1]),Math.ceil(b[2]/this._chunkSize[2])],this._workingDir,c))};t.prototype.setResolutionLevel=function(a){a=Math.round(a);0<=a&&a<this._chunkCollections.length&&(this._resolutionLevel=a)};t.prototype.getCurrentResolutionLevel=function(){return this._resolutionLevel};t.prototype.getCurrentChunkSizeWc=function(){return this._chunkCollections[this._resolutionLevel].getSizeChunkWc()};
t.prototype.getChunkSizeWcByLvl=function(a){return this._chunkCollections[a].getSizeChunkWc()};t.prototype.get8ClosestTextureData=function(a){return this._chunkCollections[this._resolutionLevel].get8ClosestTextureData(a)};t.prototype.get8ClosestTextureDataByLvl=function(a,b){return this._chunkCollections[b].get8ClosestTextureData(a)};t.prototype._determineChunkSize=function(a){this._chunkSize=a[0].chunk_sizes[0]};t.prototype._computeBoundingBox=function(a){this._boundingBox=[a[0].size[0]/64,a[0].size[1]/
64,a[0].size[2]/64]};t.prototype.getBoundingBox=function(){return this._boundingBox.slice()};t.prototype.isInside=function(a,b,c){return 0<a&&a<this._boundingBox[0]&&0<b&&b<this._boundingBox[1]&&0<c&&c<this._boundingBox[2]};t.prototype.onConfigError=function(a){this._onConfigErrorCallback=a};var x=function(a){this._sphere=new THREE.Object3D;var b=new THREE.CircleGeometry(a,64),c=new THREE.CircleGeometry(a,64),d=new THREE.CircleGeometry(a,64),k=new THREE.LineBasicMaterial({color:16724787,linewidth:1.5}),
e=new THREE.LineBasicMaterial({color:60238,linewidth:1.5}),f=new THREE.LineBasicMaterial({color:35071,linewidth:1.5});b.vertices.shift();c.vertices.shift();d.vertices.shift();k=new THREE.Line(b,k);k.name="xCircle";b.rotateY(Math.PI/2);b=new THREE.Line(c,e);b.name="yCircle";c.rotateX(-Math.PI/2);c=new THREE.Line(d,f);c.name="zCircle";this._sphere=new THREE.Object3D;this._sphere.add(k);this._sphere.add(b);this._sphere.add(c);c=new THREE.Geometry;c.vertices.push(new THREE.Vector3(-a,0,0),new THREE.Vector3(a,
0,0));c=new THREE.Line(c,new THREE.LineBasicMaterial({color:16724787,linewidth:1.5}));d=new THREE.Geometry;d.vertices.push(new THREE.Vector3(0,-a,0),new THREE.Vector3(0,a,0));d=new THREE.Line(d,new THREE.LineBasicMaterial({color:60238,linewidth:1.5}));f=new THREE.Geometry;f.vertices.push(new THREE.Vector3(0,0,-a),new THREE.Vector3(0,0,a));f=new THREE.Line(f,new THREE.LineBasicMaterial({color:35071,linewidth:1.5}));this._sphere.add(c);this._sphere.add(d);this._sphere.add(f);f=new THREE.TextureLoader;
c=f.load("textures/left.png");k=f.load("textures/right.png");e=f.load("textures/anterior.png");b=f.load("textures/posterior.png");d=f.load("textures/superior.png");f=f.load("textures/inferior.png");c=new THREE.Sprite(new THREE.SpriteMaterial({map:c}));k=new THREE.Sprite(new THREE.SpriteMaterial({map:k}));e=new THREE.Sprite(new THREE.SpriteMaterial({map:e}));b=new THREE.Sprite(new THREE.SpriteMaterial({map:b}));d=new THREE.Sprite(new THREE.SpriteMaterial({map:d}));f=new THREE.Sprite(new THREE.SpriteMaterial({map:f}));
a*=1.4;c.position.set(a,0,0);k.position.set(-a,0,0);e.position.set(0,a,0);b.position.set(0,-a,0);d.position.set(0,0,-a);f.position.set(0,0,a);this._sphere.add(c);this._sphere.add(k);this._sphere.add(e);this._sphere.add(b);this._sphere.add(d);this._sphere.add(f);this._sphere.children.forEach(function(a){a.layers.enable(0);a.layers.enable(1)})};x.prototype.addTo=function(a){a.add(this._sphere)};x.prototype.rescale=function(a){this._sphere.scale.x=a;this._sphere.scale.y=a;this._sphere.scale.z=a};x.prototype.rescaleFromResolutionLvl=
function(a){a=1/Math.pow(2,a);this._sphere.scale.x=a;this._sphere.scale.y=a;this._sphere.scale.z=a};x.prototype.setPosition=function(a){this._sphere.position.x=a.x;this._sphere.position.y=a.y;this._sphere.position.z=a.z};x.prototype.toggle=function(){this._sphere.visible=!this._sphere.visible};var q=function(a,b){b=void 0===b?"container":b;this._quadViews=a;this._windowSize={width:window.innerWidth,height:window.innerHeight};this._mouse={x:0,y:0};this._mouseLastPosition={x:-1,y:-1};this._mouseDistance=
{x:0,y:0};this._indexViewMouseDown=this._indexCurrentView=-1;this._shiftKeyPressed=this._tKeyPressed=this._rKeyPressed=this._mousePressed=!1;document.getElementById(b).addEventListener("mousemove",this._onMouseMove.bind(this),!1);document.getElementById(b).addEventListener("mousedown",this._onMouseDown.bind(this),!1);document.getElementById(b).addEventListener("mouseup",this._onMouseUp.bind(this),!1);document.addEventListener("keydown",this._onKeyDown.bind(this),!1);document.addEventListener("keyup",
this._onKeyUp.bind(this),!1);this._multiplaneContainer=this._onDonePlayingCallback=this._onArrowDownCallback=this._onArrowUpCallback=this._onScrollViewCallback=this._onGrabViewTransverseRotateCallback=this._onGrabViewRotateCallback=this._onGrabViewTranslateCallback=null;this._raycaster=new THREE.Raycaster;this._onClickPlaneCallback={perspective:null,ortho:null}};q.prototype.updateWindowSize=function(a,b){this._windowSize.width=a;this._windowSize.height=b;this._quadViews.forEach(function(a){a.updateRatio()})};
...
b.x,this._mouseLastPosition.y-b.y,this._mouseLastPosition.z-b.z)).normalize();var c=(new THREE.Vector3(this._mouse.x-b.x,this._mouse.y-b.y,this._mouse.z-b.z)).normalize(),b=Math.acos(a.dot(c));a=Math.sign(a.cross(c).z);this._onGrabViewRotateCallback&&this._onGrabViewRotateCallback(b,a,this._indexViewMouseDown)}else this._tKeyPressed?this._onGrabViewTransverseRotateCallback&&this._onGrabViewTransverseRotateCallback(this._mouseDistance,this._indexViewMouseDown):this._onGrabViewTranslateCallback&&this._onGrabViewTranslateCallback(this._mouseDistance,
this._indexViewMouseDown);this._mouseLastPosition.x=this._mouse.x;this._mouseLastPosition.y=this._mouse.y}};q.prototype._onMouseDown=function(a){this._mousePressed=!0;this._indexViewMouseDown=this._indexCurrentView;this._shiftKeyPressed&&this._intersectMultiplane(a);this._mouseLastPosition.x=this._mouse.x;this._mouseLastPosition.y=this._mouse.y};q.prototype._onMouseUp=function(a){this._mousePressed=!1;this._indexViewMouseDown=-1;this._mouseDistance.x=0;this._mouseDistance.y=0;this._onDonePlayingCallback&&
this._onDonePlayingCallback()};q.prototype._onKeyDown=function(a){switch(a.key){case "r":this._rKeyPressed=!0;break;case "t":this._tKeyPressed=!0;break;case "Shift":this._shiftKeyPressed=!0;break;case "ArrowDown":this._onArrowDownCallback&&this._onArrowDownCallback(this._indexCurrentView);break;case "ArrowUp":this._onArrowUpCallback&&this._onArrowUpCallback(this._indexCurrentView)}};q.prototype._onKeyUp=function(a){switch(a.key){case "r":this._rKeyPressed=!1;break;case "t":this._tKeyPressed=!1;break;
case "Shift":this._shiftKeyPressed=!1}this._onDonePlayingCallback&&this._onDonePlayingCallback()};q.prototype._manageQuadViewsMouseActivity=function(){var a=this,b=this._mouse.x,c=this._mouse.y;this._quadViews.forEach(function(d,e){d.isInViewWindow(b,c)?(a._indexCurrentView=e,d.enableControl()):d.disableControl()})};q.prototype.onGrabViewTranslate=function(a){this._onGrabViewTranslateCallback=a};q.prototype.onGrabViewRotate=function(a){this._onGrabViewRotateCallback=a};q.prototype.onGrabViewTransverseRotate=
function(a){this._onGrabViewTransverseRotateCallback=a};q.prototype.onArrowDown=function(a){this._onArrowDownCallback=a};q.prototype.onArrowUp=function(a){this._onArrowUpCallback=a};q.prototype.onDonePlaying=function(a){this._onDonePlayingCallback=a};q.prototype.setMultiplaneContainer=function(a){this._multiplaneContainer=a};q.prototype._intersectMultiplane=function(){var a=1/this._quadViews[this._indexViewMouseDown].getConfigParam("width"),b=1/this._quadViews[this._indexViewMouseDown].getConfigParam("height"),
c=this._quadViews[this._indexViewMouseDown].getConfigParam("left"),d=this._quadViews[this._indexViewMouseDown].getConfigParam("bottom"),a=new THREE.Vector2(2*(this._mouse.x*a-c*a)-1,2*(this._mouse.y*b-d*b)-1);this._raycaster.setFromCamera(a,this._quadViews[this._indexViewMouseDown].getCamera());a=this._raycaster.intersectObject(this._multiplaneContainer,!0);a.length&&(this._quadViews[this._indexViewMouseDown].isPerspective()?this._onClickPlaneCallback.perspective&&this._onClickPlaneCallback.perspective(a[0].point):
this._onClickPlaneCallback.ortho&&this._onClickPlaneCallback.ortho(a[0].point))};q.prototype.onClickPlane=function(a,b){a in this._onClickPlaneCallback?this._onClickPlaneCallback[a]=b:console.warn('The camera type must be "perspective" or "ortho".')};var v=function(){this._defaultMapFolder="";this._colormapsToLoad=[];this._colormapSuccessCounter=0;this._colorMaps={};this._onColormapUpdateCallback=null;this._currentColormap={id:"none",colormap:null};this._isEnabled=!1;this._textureLoader=new THREE.TextureLoader;
this._colorMaps.none=null};v.prototype._loadColormap=function(a,b){b=void 0===b?!0:b;var c=this,d=(new String(a)).substring(a.lastIndexOf("/")+1);-1!=d.lastIndexOf(".")&&(d=d.substring(0,d.lastIndexOf(".")));this._textureLoader.load(a,function(a){c._colormapSuccessCounter++;c._colorMaps[d]=a;b&&(c._currentColormap.id=d,c._currentColormap.colormap=a);c._colormapSuccessCounter==c._colormapsToLoad.length&&c._onColormapUpdateCallback&&c._onColormapUpdateCallback()},function(a){},function(b){console.error("Failed to load "+
a)})};v.prototype.loadCollection=function(a){var b=this,c=a.url;m.loadTextFile(c,function(a){b._defaultMapFolder=c.substring(0,Math.max(c.lastIndexOf("/"),c.lastIndexOf("\\")))+"/";b._colormapsToLoad=JSON.parse(a);b._colormapsToLoad.forEach(function(a){b._loadColormap(b._defaultMapFolder+a,!1)})},function(){console.warn("Unable to load the colormap list file ( "+c+" ).")})};v.prototype.getCurrentColorMap=function(){return this._currentColormap};v.prototype.isColormappingEnabled=function(){return this._isEnabled};
v.prototype.enableColorMapping=function(){this._isEnabled=!0};v.prototype.disableColorMapping=function(){this._isEnabled=!1};v.prototype.getAvailableColormaps=function(){return Object.keys(this._colorMaps)};v.prototype.useColormap=function(a){return this._colorMaps.hasOwnProperty(a)?(this._currentColormap.id=a,this._currentColormap.colormap=this._colorMaps[a],"none"==a?this.disableColorMapping():this.enableColorMapping(),!0):!1};v.prototype.onColormapUpdate=function(a){this._onColormapUpdateCallback=
a};var p=function(a,b){this._plane=new THREE.Object3D;this._plane.name="projection plane";this._subPlaneSize=a/Math.sqrt(2);this._subPlanes=[];this._shaderMaterials=[];this._subPlaneDim={row:7,col:15};this._colormapManager=b;this._levelManager=null;this._resolutionLevel=0;this._buildSubPlanes()};p.prototype._buildSubPlanes=function(){for(var a=new THREE.PlaneBufferGeometry(this._subPlaneSize,this._subPlaneSize,1),b=new THREE.DataTexture(new Uint8Array(1),1,1,THREE.LuminanceFormat,THREE.UnsignedByteType),
...
side:THREE.DoubleSide,transparent:!0}),c=0;c<this._subPlaneDim.row;c++)for(var d=0;d<this._subPlaneDim.col;d++){var e=b.clone(),f=new THREE.Mesh(a,e);f.position.set(-this._subPlaneDim.col*this._subPlaneSize/2+d*this._subPlaneSize+this._subPlaneSize/2,-this._subPlaneDim.row*this._subPlaneSize/2+c*this._subPlaneSize+this._subPlaneSize/2,0);this._plane.add(f);this._subPlanes.push(f);this._shaderMaterials.push(e)}};p.prototype.setLevelManager=function(a){this._levelManager=a};p.prototype.setMeshColor=
...
n.prototype.getSurfaceProperties=function(){return this._shapeData.surfaceProperties};var z=function(a,b){this._container=b;this._meshes={};this._collectionBox=this._configFileDir=null;this._readConfig(a)};z.prototype._readConfig=function(a){var b=this,c=a.url;m.loadTextFile(c,function(a){b._configFileDir=c.substring(0,Math.max(c.lastIndexOf("/"),c.lastIndexOf("\\")))+"/";b._loadConfigDescription(JSON.parse(a))},function(a){console.error("Could not load config file "+c);b._onConfigErrorCallback&&
b._onConfigErrorCallback(c,0)})};z.prototype._loadConfigDescription=function(a){var b=this;a.forEach(function(a){var c=a.url;"near"==a.urlType&&(c=b._configFileDir+c);m.loadTextFile(c,function(c){var d=new n;d.parse(c);c=b._buildMeshFromObjReader(d);c.geometry.computeBoundingBox();c.name=a.id;c.userData.longName=a.name;c.userData.description=a.description;"eulerAngle"in a&&c.rotation.set(a.eulerAngle[0],a.eulerAngle[1],a.eulerAngle[2]);"scale"in a&&c.scale.set(a.scale[0],a.scale[1],a.scale[2]);"position"in
a&&c.position.set(a.position[0],a.position[1],a.position[2]);c.layers.enable(0);c.layers.enable(1);b._meshes[a.id]=c;b._container.add(c);b._updateCollectionBox(c)},function(a){console.error("Could not load mesh file "+c)})})};z.prototype._buildMeshFromObjReader=function(a){var b=new THREE.BufferGeometry,c=a.getShapeRawIndices(0),d=a.getRawVertices(),e=a.getRawNormals(),f=a.getRawColors();b.setIndex(new THREE.BufferAttribute(c,1));b.addAttribute("position",new THREE.BufferAttribute(d,3));b.addAttribute("normal",
new THREE.BufferAttribute(e,3,!0));b.addAttribute("color",new THREE.BufferAttribute(f,4,!0));b.computeBoundingSphere();a=new THREE.MeshPhongMaterial({specular:16777215,shininess:250,side:THREE.DoubleSide,vertexColors:THREE.VertexColors,transparent:!0,opacity:a.getSurfaceProperties().transparency});return new THREE.Mesh(b,a)};z.prototype._updateCollectionBox=function(a){this._collectionBox?this._collectionBox.union(a.geometry.boundingBox):this._collectionBox=a.geometry.boundingBox.clone()};var w=function(a){this._quadScene=
a;this._resolutionLevel=this._quadScene.getResolutionLevel();this._resolutionLvlRange=[0,6];this._resolutionLvlSliderBuilt=!1;this._resolutionDescription="";this._colormapManager=this._quadScene.getColormapManager();this._colormapManager.onColormapUpdate(this._updateColormapList.bind(this));this._controlKit=new ControlKit;this._mainPanel=this._controlKit.addPanel({label:document.title,align:"left",fixed:!1,width:250,position:[window.innerWidth-250,0]});this._initActions()};w.prototype._initActions=
function(){var a=this._mainPanel.addSubGroup({label:"Helpers"});a.addButton("Toggle compass",this._toggleOrientationHelper.bind(this));a.addButton("Toggle bounding box",this._toggleBoundingBoxHelper.bind(this));this._navigationSubGroup=this._mainPanel.addSubGroup({label:"Navigation"});this._navigationSubGroup.addButton("Reset orientation",this._resetMultiplaneRotation.bind(this))};w.prototype._toggleOrientationHelper=function(){this._quadScene.getOrientationHelper().toggle()};w.prototype._toggleBoundingBoxHelper=
function(){this._quadScene.getBoundingBoxHelper().toggle()};w.prototype.updateResolutionLevelUI=function(a){this._resolutionLevel=a;this._resolutionLvlSliderBuilt||(this._buildResolutionLevelSlider(),this._resolutionLvlSliderBuilt=!0)};w.prototype._buildResolutionLevelSlider=function(){var a=this;this._navigationSubGroup.addSlider(this,"_resolutionLevel","_resolutionLvlRange",{label:"Zoom level",step:1,dp:0,onFinish:function(b){a._quadScene.setResolutionLevel(a._resolutionLevel)}});this._navigationSubGroup.addStringOutput(this,
"_resolutionDescription",{label:"Resolution"})};w.prototype._updateColormapList=function(){var a=this,b={maps:this._colormapManager.getAvailableColormaps(),selection:null};b.selection=b.maps[0];this._mainPanel.addSubGroup({label:"Colormaps"}).addSelect(b,"maps",{label:"Choose",target:"selection",onChange:function(c){a._colormapManager.useColormap(b.maps[c])}})};w.prototype._resetMultiplaneRotation=function(){this._quadScene.setMultiplaneRotation(0,0,0)};var y=function(a){this._size=null;this._parentElem=
a;this._boundingBox3D=null};y.prototype.build=function(a){this._size=a.slice();if(!this._boundingBox3D){this._boundingBox3D=new THREE.Object3D;a=new THREE.MeshBasicMaterial({transparent:!0,opacity:.8,color:16777215,vertexColors:THREE.FaceColors,side:THREE.BackSide});var b=new THREE.BoxGeometry(this._size[0],this._size[1],this._size[2]);b.faces[0].color.setHex(16743034);b.faces[1].color.setHex(16743034);b.faces[2].color.setHex(16724787);b.faces[3].color.setHex(16724787);b.faces[4].color.setHex(6421140);
b.faces[5].color.setHex(6421140);b.faces[6].color.setHex(11008707);b.faces[7].color.setHex(11008707);b.faces[8].color.setHex(9817340);b.faces[9].color.setHex(9817340);b.faces[10].color.setHex(35071);b.faces[11].color.setHex(35071);a=new THREE.Mesh(b,a);this._boundingBox3D.add(a);this._boundingBox3D.position.x=this._size[0]/2;this._boundingBox3D.position.y=this._size[1]/2;this._boundingBox3D.position.z=this._size[2]/2;this._boundingBox3D.children.forEach(function(a){a.layers.disable(0);a.layers.enable(1)});
this._parentElem.add(this._boundingBox3D)}};y.prototype.isInside=function(a,b,c){return 0<a&&a<this._size[0]&&0<b&&b<this._size[1]&&0<c&&c<this._size[2]};y.prototype.show=function(){this._boundingBox3D.visible=!0};y.prototype.hide=function(){this._boundingBox3D.visible=!1};y.prototype.toggle=function(){this._boundingBox3D.visible=!this._boundingBox3D.visible};g=function(a,b){b=void 0===b?0:b;window.addEventListener("resize",this._updateSize.bind(this),!1);this._ready=!1;this._counterRefresh=0;this._resolutionLevel=
b;this._quadViews=[];this._onConfigFileErrorCallback=this._onReadyCallback=this._onChangeCallback=this._orientationHelper=this._planeManager=this._quadViewInteraction=null;this._colormapManager=new v;this._domContainer=document.getElementById(a);this._scene=new THREE.Scene;this._boundingBoxHelper=new y(this._scene);b=new THREE.AxisHelper(1);b.layers.enable(1);this._scene.add(b);this._scene.add(new THREE.AmbientLight(4473924));b=new THREE.DirectionalLight(16777215,.75);b.position.set(200,200,200);
b.layers.enable(0);b.layers.enable(1);this._scene.add(b);this._adjustedContainer=new THREE.Object3D;this._annotationContainer=new THREE.Object3D;this._meshContainer=new THREE.Object3D;this._adjustedContainer.add(this._meshContainer);this._adjustedContainer.add(this._annotationContainer);this._scene.add(this._adjustedContainer);this._renderer=new THREE.WebGLRenderer({antialias:!0});this._renderer.setPixelRatio(window.devicePixelRatio);this._renderer.setSize(window.innerWidth,window.innerHeight);this._domContainer.appendChild(this._renderer.domElement);
this._cameraDistance=10;this._windowSize={width:0,height:0};this._stats=this._meshCollection=null;this._initPlaneManager();this._initViews(a);this._levelManager=new t;this._guiController=new w(this);this._animate()};g.prototype._initViews=function(a){var b=this,c=new f(this._scene,this._renderer,this._cameraDistance);c.initTopLeft();c.initOrthoCamera();c.useRelativeCoordinatesOf(this._planeManager.getMultiplaneContainer());c.enableLayer(0);var d=new f(this._scene,this._renderer,this._cameraDistance);
d.initTopRight();d.initOrthoCamera();d.useRelativeCoordinatesOf(this._planeManager.getMultiplaneContainer());d.enableLayer(0);var e=new f(this._scene,this._renderer,this._cameraDistance);e.initBottomLeft();e.initOrthoCamera();e.useRelativeCoordinatesOf(this._planeManager.getMultiplaneContainer());e.enableLayer(0);var g=new f(this._scene,this._renderer,this._cameraDistance);g.initBottomRight();g.initPerspectiveCamera();g.enableLayer(1);g.disableLayer(0);g.addTrackballControl(this._render,this._domContainer);
this._quadViews.push(c);this._quadViews.push(d);this._quadViews.push(e);this._quadViews.push(g);this._quadViewInteraction=new q(this._quadViews,a);this._quadViewInteraction.setMultiplaneContainer(this._planeManager.getMultiplaneContainer());this._quadViewInteraction.onClickPlane("perspective",function(a){b.setMultiplanePosition(a.x,a.y,a.z)})};g.prototype.setMultiplanePosition=function(a,b,c){this._planeManager.setMultiplanePosition(a,b,c)};g.prototype.setMultiplaneRotation=function(a,b,c){this._planeManager.setMultiplaneRotation(a,
b,c)};g.prototype._initPlaneManager=function(){var a=this;this._planeManager=new h(this._colormapManager,this._scene);this._planeManager.enableLayerHiRez(0);this._planeManager.disableLayerHiRez(1);this._planeManager.enableLayerLoRez(1);this._planeManager.disableLayerLoRez(0);this._planeManager.onMultiplaneMove(function(b){a._updatePerspectiveCameraLookAt(b);a._syncOrientationHelperPosition(b)})};g.prototype.initStat=function(){this._stats=new Stats;this._domContainer.appendChild(this._stats.dom)};
g.prototype._updateSize=function(){if(this._windowSize.width!=window.innerWidth||this._windowSize.height!=window.innerHeight)this._windowSize.width=window.innerWidth,this._windowSize.height=window.innerHeight,this._quadViewInteraction.updateWindowSize(this._windowSize.width,this._windowSize.height),this._renderer.setSize(this._windowSize.width,this._windowSize.height)};g.prototype.getResolutionLevel=function(){return this._resolutionLevel};g.prototype.getColormapManager=function(){return this._colormapManager};
g.prototype._animate=function(){this._render();this._stats&&this._stats.update();requestAnimationFrame(this._animate.bind(this));this._quadViews[3].updateControl()};g.prototype._render=function(){this._ready&&(0==this._counterRefresh%30&&this._updateAllPlanesShaderUniforms(),this._counterRefresh++);this._quadViews.forEach(function(a){a.renderView()})};g.prototype.getOrientationHelper=function(){return this._orientationHelper};g.prototype.getBoundingBoxHelper=function(){return this._boundingBoxHelper};
g.prototype.loadData=function(a){"precomputed_octree_tiles"==a.datatype?this._initLevelManager(a):"mesh_collection"==a.datatype?this._initMeshCollection(a):"colormap_collection"==a.datatype?this._colormapManager.loadCollection(a):console.warn("The data to load has an unknown format.")};g.prototype._initMeshCollection=function(a){this._meshCollection=new z(a,this._meshContainer)};g.prototype._initLevelManager=function(a){var b=this;this._levelManager.loadConfig(a);this._levelManager.onReady(function(){var a=
b._levelManager.getBoundingBox();b._planeManager.setLevelManager(b._levelManager);b._levelManager.setResolutionLevel(b._resolutionLevel);b._boundingBoxHelper.build(a);b._planeManager.setMultiplanePosition(a[0]/2,a[1]/2,a[2]/2);b._initOrientationHelper(new THREE.Vector3(a[0]/2,a[1]/2,a[2]/2));b._initPlaneInteraction();b._ready=!0;b._onReadyCallback&&b._onReadyCallback(b)});this._levelManager.onConfigError(function(a,d){b._onConfigFileErrorCallback&&b._onConfigFileErrorCallback(a,d)})};g.prototype.setResolutionLevel=
function(a){console.log("--------- LVL "+a+" ---------------");this._resolutionLevel=a;this._levelManager.setResolutionLevel(this._resolutionLevel);this._planeManager.updateScaleFromRezLvl(this._resolutionLevel);this._syncOrientationHelperScale();this._updateOthoCamFrustrum();this._guiController.updateResolutionLevelUI(a);this._onUpdateViewCallback&&this._onUpdateViewCallback(this.getMultiplaneContainerInfo())};g.prototype._updateAllPlanesShaderUniforms=function(){this._planeManager.updateUniforms()};
g.prototype._updatePerspectiveCameraLookAt=function(a){this._quadViews[3].updateLookAt(a)};g.prototype._updateOthoCamFrustrum=function(){var a=1/Math.pow(2,this._resolutionLevel);this._quadViews[0].updateOrthoCamFrustrum(a);this._quadViews[1].updateOrthoCamFrustrum(a);this._quadViews[2].updateOrthoCamFrustrum(a)};g.prototype._initOrientationHelper=function(a){this._orientationHelper=new x(this._planeManager.getWorldDiagonalHiRez()/13);this._orientationHelper.addTo(this._scene);this._syncOrientationHelperPosition(a)};
g.prototype._syncOrientationHelperPosition=function(a){this._orientationHelper&&this._orientationHelper.setPosition(a)};g.prototype._syncOrientationHelperScale=function(){this._orientationHelper.rescaleFromResolutionLvl(this._resolutionLevel)};g.prototype.onReady=function(a){this._onReadyCallback=a};g.prototype._initPlaneInteraction=function(){var a=this;this._quadViewInteraction.onGrabViewTranslate(function(b,c){var d=Math.pow(2,a._resolutionLevel);switch(c){case 0:a._planeManager.translateMultiplaneX(-b.x/
d,b.y/d);break;case 1:a._planeManager.translateMultiplaneY(b.x/d,b.y/d);break;case 2:a._planeManager.translateMultiplaneZ(b.x/d,-b.y/d)}});this._quadViewInteraction.onGrabViewRotate(function(b,c,d){switch(d){case 0:a._planeManager.rotateMultiplaneX(b*c);break;case 1:a._planeManager.rotateMultiplaneY(b*c*-1);break;case 2:a._planeManager.rotateMultiplaneZ(b*c)}});this._quadViewInteraction.onGrabViewTransverseRotate(function(b,c){var d=a._resolutionLevel/2;switch(c){case 0:a._planeManager.rotateMultiplaneZ(b.x/
d);a._planeManager.rotateMultiplaneY(-b.y/d);break;case 1:a._planeManager.rotateMultiplaneX(-b.y/d);a._planeManager.rotateMultiplaneZ(b.x/d);break;case 2:a._planeManager.rotateMultiplaneX(-b.y/d),a._planeManager.rotateMultiplaneY(b.x/d)}});this._quadViewInteraction.onArrowDown(function(b){var c=.01/Math.pow(2,a._resolutionLevel);switch(b){case 0:a._planeManager.translateMultiplaneY(c,0);break;case 1:a._planeManager.translateMultiplaneX(c,0);break;case 2:a._planeManager.translateMultiplaneY(0,-c)}});
this._quadViewInteraction.onArrowUp(function(b){var c=.01/Math.pow(2,a._resolutionLevel)*-1;switch(b){case 0:a._planeManager.translateMultiplaneY(c,0);break;case 1:a._planeManager.translateMultiplaneX(c,0);break;case 2:a._planeManager.translateMultiplaneY(0,-c)}});this._quadViewInteraction.onDonePlaying(function(){a._onUpdateViewCallback&&a._onUpdateViewCallback(a.getMultiplaneContainerInfo())})};g.prototype.getMultiplaneContainerInfo=function(){var a=this._planeManager.getMultiplanePosition(),b=
this._planeManager.getMultiplaneRotation();return{resolutionLvl:this._resolutionLevel,position:{x:a.x,y:a.y,z:a.z},rotation:{x:b.x,y:b.y,z:b.z}}};g.prototype.onUpdateView=function(a){this._onUpdateViewCallback=a};g.prototype.onConfigFileError=function(a){this._onConfigFileErrorCallback=a};e.HashIO=l;e.QuadScene=g;Object.defineProperty(e,"__esModule",{value:!0})});
