...
0<b&&b<this._boundingBox[1]&&0<c&&c<this._boundingBox[2]};p.prototype.onConfigError=function(a){this._onConfigErrorCallback=a};p.prototype.getLevelInfo=function(a,b){if(0<=a&&a<this._levelsInfo.length&&b in this._levelsInfo[a])return this._levelsInfo[a][b]};var x=function(a){this._sphere=new THREE.Object3D;var b=new THREE.CircleGeometry(a,64),c=new THREE.CircleGeometry(a,64),d=new THREE.CircleGeometry(a,64),k=new THREE.LineBasicMaterial({color:16724787,linewidth:1.5}),e=new THREE.LineBasicMaterial({color:60238,
...
b.position.set(0,-a,0);d.position.set(0,0,-a);f.position.set(0,0,a);this._sphere.add(c);this._sphere.add(k);this._sphere.add(e);this._sphere.add(b);this._sphere.add(d);this._sphere.add(f);this._sphere.children.forEach(function(a){a.layers.enable(0);a.layers.enable(1)})};x.prototype.addTo=function(a){a.add(this._sphere)};x.prototype.rescale=function(a){this._sphere.scale.x=a;this._sphere.scale.y=a;this._sphere.scale.z=a};x.prototype.rescaleFromResolutionLvl=function(a){a=1/Math.pow(2,a);this._sphere.scale.x=
a;this._sphere.scale.y=a;this._sphere.scale.z=a};x.prototype.setPosition=function(a){this._sphere.position.x=a.x;this._sphere.position.y=a.y;this._sphere.position.z=a.z};x.prototype.toggle=function(){this._sphere.visible=!this._sphere.visible};x.prototype.setVisibility=function(a){this._sphere.visible=a};var r=function(a,b){this._quadViews=a;this._windowSize={width:window.innerWidth,height:window.innerHeight};this._domContainer=document.getElementById(void 0===b?"container":b);this._mouse={x:0,y:0};
...
a;this._resolutionLevel=this._quadScene.getResolutionLevel();this._resolutionLvlRange=[0,6];this._resolutionLvlSliderBuilt=!1;this._resolutionDescription="";this._colormapManager=this._quadScene.getColormapManager();this._colormapManager.onColormapUpdate(this._updateColormapList.bind(this));this._mainPanel=QuickSettings.create(window.innerWidth-250,0,document.title);this._initActions()};w.prototype._initActions=function(){var a=this;this._mainPanel.addBoolean("Compass",1,function(b){a._quadScene.getOrientationHelper().setVisibility(b)});
...
a;this._mainPanel.setValue("Zoom level",a);this._updateResolutionDescription(this._resolutionLevel)};w.prototype.updateMultiplaneUI=function(a){var b=a.position.x.toFixed(4)+" , ",b=b+(a.position.y.toFixed(4)+" , "),b=b+a.position.z.toFixed(4);this._mainPanel.setValue("Position",b);b=a.rotation.x.toFixed(4)+" , ";b+=a.rotation.y.toFixed(4)+" , ";b+=a.rotation.z.toFixed(4);this._mainPanel.setValue("Rotation",b)};w.prototype._updateResolutionDescription=function(a,b){this._resolutionDescription=(void 0===
b?"":b)+this._quadScene.getLevelManager().getLevelInfo(a,"key");this._mainPanel.setValue("Resolution",this._resolutionDescription)};w.prototype._updateColormapList=function(){var a=this;this._mainPanel.addDropDown("Colormap",this._colormapManager.getAvailableColormaps(),function(b){a._colormapManager.useColormap(b.value)})};var y=function(a){this._size=null;this._parentElem=a;this._boundingBox3D=null};y.prototype.build=function(a){this._size=a.slice();if(!this._boundingBox3D){this._boundingBox3D=
...
b.faces[9].color.setHex(9817340);b.faces[10].color.setHex(35071);b.faces[11].color.setHex(35071);a=new THREE.Mesh(b,a);this._boundingBox3D.add(a);this._boundingBox3D.position.x=this._size[0]/2;this._boundingBox3D.position.y=this._size[1]/2;this._boundingBox3D.position.z=this._size[2]/2;this._boundingBox3D.children.forEach(function(a){a.layers.disable(0);a.layers.enable(1)});this._parentElem.add(this._boundingBox3D)}};y.prototype.isInside=function(a,b,c){return 0<a&&a<this._size[0]&&0<b&&b<this._size[1]&&
0<c&&c<this._size[2]};y.prototype.show=function(){this._boundingBox3D.visible=!0};y.prototype.hide=function(){this._boundingBox3D.visible=!1};y.prototype.toggle=function(){this._boundingBox3D.visible=!this._boundingBox3D.visible};y.prototype.setVisibility=function(a){this._boundingBox3D.visible=a};g=function(a,b){b=void 0===b?0:b;window.addEventListener("resize",this._updateSize.bind(this),!1);this._ready=!1;this._counterRefresh=0;this._resolutionLevel=b;this._quadViews=[];this._onConfigFileErrorCallback=
...
0);break;case 2:a._planeManager.translateMultiplaneY(0,-c)}});this._quadViewInteraction.onArrowUp(function(b){var c=.01/Math.pow(2,a._resolutionLevel)*-1;switch(b){case 0:a._planeManager.translateMultiplaneY(c,0);break;case 1:a._planeManager.translateMultiplaneX(c,0);break;case 2:a._planeManager.translateMultiplaneY(0,-c)}});this._quadViewInteraction.onDonePlaying(function(){a._guiController.updateMultiplaneUI(a.getMultiplaneContainerInfo());a._onUpdateViewCallback&&a._onUpdateViewCallback(a.getMultiplaneContainerInfo())})};
