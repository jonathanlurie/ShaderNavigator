...
(function() {
	...
	var QuickSettings = {
		 ...
		 * @returns {module:QuickSettings}
		 */
		addRange: function(title, min, max, value, step, callback, callback2) {
			return this._addNumber("range", title, min, max, value, step, callback, callback2);
		},
		 ...
		 * @returns {module:QuickSettings}
		 */
		addNumber: function(title, min, max, value, step, callback, callback2) {
			return this._addNumber("number", title, min, max, value, step, callback, callback2);
		},

		_addNumber: function(type, title, min, max, value, step, callback, callback2) {
			var container = this._createContainer();
